...
#from model_training import coordinate_unet
...
# Load configurations
with open('configs2.json', 'r') as cfg_file:
...
class BaseTrain:
    ...
    def init_datasets(self):
        # Assuming the total number of unique data points is 814 (excluding color augmented data)
        unique_indices = range(445)
        #unique_indices = range(156)
    ...
    def train(self):
        for epoch in range(self.cfgs["epochs"]):
            ...
            for i, data in enumerate(self.train_loader):
                ...
                #squared_diffs = ((outputs - labels) ** 2)
            ...
            self.scheduler.step()
            # save every 4 epochs and include timestamp
            checkpoint = {
                'epoch': epoch,
            ...
            try:
                if epoch % 4 == 0:
                    ...
                    print("path ", os.path.join(self.chkpnts_path, checkpoint_filename))
